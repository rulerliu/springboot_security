package com.mayikt.security.securitycfg;//package com.mayikt.security;
//
//import com.alibaba.fastjson.JSON;
//import com.alibaba.fastjson.JSONObject;
//import com.mayikt.utils.HttpUtils;
//import com.mayikt.utils.JwtTokenUtils;
...
///**
// * 启动登录认证流程过滤器
// * JwtLoginFilter 是在通过访问 /login 的POST请求是被首先被触发的过滤器，默认实现是 UsernamePasswordAuthenticationFilter
// * 它继承了 AbstractAuthenticationProcessingFilter，抽象父类的 doFilter 定义了登录认证的大致操作流程
// * 这里我们的 JwtLoginFilter 继承了 UsernamePasswordAuthenticationFilter，并进行了两个主要内容的定制。
