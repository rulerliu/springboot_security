...
import com.mayikt.api.SysRoleService;
...
import com.mayikt.mapper.SysRoleMenuMapper;
import com.mayikt.mapper.SysUserRoleMapper;
...
public class SysRoleServiceImpl implements SysRoleService {
    ...
    public CommonResult addRole(SysRoleReqBO sysRoleReqBO) {
...
//        return roleRspBO;
    ...
    public List<SysRole> getRoles(Long userId) {
        List<SysRole> roles = sysRoleMapper.getRoles(userId);
        return roles;
    }
