...
import com.mayikt.security.utils.*;
import com.mayikt.user.api.SysOrgService;
import com.mayikt.user.api.SysUserService;
import com.mayikt.user.bo.MenuTreeRspBO;
import com.mayikt.user.mapper.*;
import com.mayikt.user.model.SysLoginLog;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
    ...
    public void logout() {
        ...
        umsAdminCacheService.deleteRoles(currentUser.getSysUser().getUserId());
        umsAdminCacheService.deleteMenus(currentUser.getSysUser().getUserId());
        umsAdminCacheService.deleteSysUser(currentUser.getSysUser().getAccount());
    }
